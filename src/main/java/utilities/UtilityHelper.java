...
public class UtilityHelper {
    ...
    public static boolean isAlertAccept() throws Exception {
    ...
    public static String switchToSubWin() {
        String parentWindowHandle = ContextUtil.get().getWebDriverInstance()
                .getWindowHandle(); // Get parent window
    ...
    public static boolean switchToParentWin(String parent_win_handle) {
        Boolean myval = false;
    ...
    public static boolean switchToParentWin_noClose(String parent_win_handle) {
        Boolean myval = false;
        WebDriver wd = ContextUtil.get().getWebDriverInstance().switchTo()
                .window(parent_win_handle); // switch back to parent window
        if (wd != null) {
    ...
    public static List<WebElement> IsElementPresent(String string) {
    ...
    public static Boolean h1containsText(String string) {
    ...
    public static Boolean licontainsText(String string) {
        Boolean h1text = ContextUtil.get().getWebDriverInstance()
    ...
    public static Boolean divcontainsText(String string) {
        System.out
                .println("the size is "
                        + ContextUtil
                        .get()
    ...
    public static String getCellData_Table(String tableClassName, int row, int col) {
    ...
    public static void clickOnCell_Table(String tableClassName, int row, int col) {
        WebElement table =ContextUtil.get().getWebDriverInstance().findElement(By.className(""+ tableClassName +""));
    ...
    public static void completeAttribute(String tableClassName, String attrName, String attrValue) {
        WebElement table =ContextUtil.get().getWebDriverInstance().findElement(By.className(""+ tableClassName +""));
