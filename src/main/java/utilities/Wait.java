...
public class Wait {
    ...
    public static Boolean webDriverWaitId(Integer waittime, String value){
    ...
    public static Boolean webDriverWaitLinkText(int i, String value){
    ...
    public static Boolean webDriverWaitWebElemnt(int i, WebElement webElement){
    ...
    public static Boolean webDriverWaitClassName(int i, String value){
    ...
    public static Boolean webDriverWaitH3ContainsText(int i, String value){
    ...
    public static Boolean webDriverWaitButtonEnabledText(int i, String value) {
    ...
    public static Boolean webDriverWaitforTDTextToAppear(int i, String value) {
    ...
    public static Boolean webDriverWaitButtonSpanText_Clickable(int i, String value) {
    ...
    public static Boolean webDriverWaitForElementDivText(int i, String value) {
        WebDriverWait wait = new WebDriverWait(ContextUtil.get().getWebDriverInstance(), i);
    ...
    public static Boolean webDriverWaitForElementDivClassText(int i, String value, String classname) {
        WebDriverWait wait = new WebDriverWait(ContextUtil.get().getWebDriverInstance(), i);
    ...
    public static Boolean webDriverWaitH2ContainsText(int i, String value) {
        WebDriverWait wait = new WebDriverWait(ContextUtil.get().getWebDriverInstance(), i);
    ...
    public static Boolean webDriverWaitH2ContainsTextValue(int i, String value) {
        WebDriverWait wait = new WebDriverWait(ContextUtil.get().getWebDriverInstance(), i);
    ...
    public static Boolean webDriverWaitH1ContainsText(int i, String value) {
        WebDriverWait wait = new WebDriverWait(ContextUtil.get().getWebDriverInstance(), i);
    ...
    public static Boolean webDriverWaitLIContainsText(int i, String value) {
        WebDriverWait wait = new WebDriverWait(ContextUtil.get().getWebDriverInstance(), i);
